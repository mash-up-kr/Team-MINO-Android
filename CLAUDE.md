...
| 컴포넌트·이미지 에셋을 어느 모듈(feature / `core:common:ui` / `core:design-system`)에 만들지 판정, 공용 모듈로 승격 | `docs/conventions/component-asset-placement.md` |
| Figma 디자인대로 화면·컴포넌트 구현, 토큰이냐 실측값이냐 판정, 디자인 대조·검증 | `docs/conventions/figma-design-fidelity.md` |
