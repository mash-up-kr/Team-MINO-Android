 ...
 *
 * 팔레트는 `:core:design-system`이 갖고 도메인 값은 `:core:domain`이 갖는다. 팔레트는 도메인을 모르고 도메인은
 * 팔레트를 모르므로, 둘의 대응은 양쪽을 모두 아는 feature가 소유한다
 * (`docs/adr/2026-08-14-room-color-palette-in-design-system.md`).
 */
internal val RoomColor.palette: MinoRoomColor?
    get() = when (this) {
